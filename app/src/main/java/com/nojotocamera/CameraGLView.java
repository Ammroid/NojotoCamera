...
public final class CameraGLView extends GLSurfaceView {
    ...
    private int mCameraId = CAMERA_ID;
    ...
    private int mScaleMode = SCALE_KEEP_ASPECT_VIEWPORT;
    private static int mFlashMode = FLASH_OFF;
    public static int skipFrame = 0;
...
/*		// the frequency of refreshing of camera preview is at most 15 fps
    ...
    public void resetPreview(int mCameraId) {
        CameraGLView.CAMERA_ID = mCameraId;
        stopPreview();
        startPreview(getWidth(), getHeight());
    }

    public int getCameraId() {
        return CameraGLView.CAMERA_ID;
    }

    public int getFlash() {
        return CameraGLView.mFlashMode;
    }

    public void setFlash(int mFlashMode) {
        CameraGLView.mFlashMode = mFlashMode;
        stopPreview();
        startPreview(getWidth(), getHeight());
    }
...
//            Log.d(TAG, "onFrameAvailable: frame skiped " + skipFrame);
            skipFrame++;
//			final CameraGLView parent = mWeakParent.get();
//			if (parent != null)
            ...
            if ((parent != null) && (mCamera == null)) {
                ...
                try {
                    ...
                    if (flashes != null && flashes.size() > 0) {
                        ...
                        } else if (mFlashMode == FLASH_TORCH) {
