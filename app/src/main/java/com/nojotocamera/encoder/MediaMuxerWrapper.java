...
public class MediaMuxerWrapper {
    ...
    private static final String DIR_NAME = "Nojoto";
...
//**********************************************************************
    ...
    public static final File getCaptureFile(final String ext) {
        String path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getAbsolutePath()+File.separator+"SnapClips";
        final File dir = new File(path);
        if (DEBUG) Log.d(TAG, "path=" + dir.toString());
        if (!dir.exists()) {
            if (!dir.mkdirs()) {
                Log.d("General Utils", "Oops! Failed create "
                        +path + " directory");
                return null;
            }
        }
